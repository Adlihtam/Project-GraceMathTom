                                ...
                                <div class="col-xs-12">
                                    <form action="" method="post" class="">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="input-lg form-control" id="surname" name="surname" placeholder="Prénom">
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="input-lg form-control" id="date" name="date" placeholder="JJ/MM/AAAA">
                                        </div>
